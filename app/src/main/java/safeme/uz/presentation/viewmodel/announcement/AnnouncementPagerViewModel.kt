...
class AnnouncementPagerViewModel @Inject constructor(
    ...
    private var getAllNewsMutableLiveData =
        MutableLiveData<RemoteApiResult<AnnouncementCategoryResponse<ArrayList<NewsData>>>>()
    val getAllNewsLiveData: LiveData<RemoteApiResult<AnnouncementCategoryResponse<ArrayList<NewsData>>>> =
